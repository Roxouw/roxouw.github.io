...
(function () {
  ...
  const themeEl = document.createElement("meta");
  ...
  if (IS_IOS || IS_SAFARI) {
    ...
    const supportsSvh = typeof CSS !== "undefined" && CSS.supports("height", "1svh");
    const unit = supportsDvh ? "100dvh" : supportsSvh ? "100svh" : null;
